...
Generated from: duck_leader_data.xml,minimal.xml
...
MAVLINK_MSG_ID_DUCK_LEADER_FOUND = 151
MAVLINK_MSG_ID_DUCK_LEADER_LOC = 152
MAVLINK_MSG_ID_HEARTBEAT = 0

class MAVLink_duck_leader_found_message(MAVLink_message):
        '''
        Tells the receiver whether leader information is available
        '''
        id = MAVLINK_MSG_ID_DUCK_LEADER_FOUND
        name = 'DUCK_LEADER_FOUND'
        fieldnames = ['duck_leader_found']
        ordered_fieldnames = [ 'duck_leader_found' ]
        format = '<B'
        ...
        def __init__(self, duck_leader_found):
                MAVLink_message.__init__(self, MAVLink_duck_leader_found_message.id, MAVLink_duck_leader_found_message.name)
                self._fieldnames = MAVLink_duck_leader_found_message.fieldnames
                self.duck_leader_found = duck_leader_found

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 103, struct.pack('<B', self.duck_leader_found))

class MAVLink_duck_leader_loc_message(MAVLink_message):
        '''
        Gives float value (-1..1) saying where leader is
        '''
        id = MAVLINK_MSG_ID_DUCK_LEADER_LOC
        name = 'DUCK_LEADER_LOC'
        fieldnames = ['duck_leader_LR', 'duck_leader_dist']
        ordered_fieldnames = [ 'duck_leader_LR', 'duck_leader_dist' ]
        format = '<ff'
        ...
        def __init__(self, duck_leader_LR, duck_leader_dist):
                MAVLink_message.__init__(self, MAVLink_duck_leader_loc_message.id, MAVLink_duck_leader_loc_message.name)
                self._fieldnames = MAVLink_duck_leader_loc_message.fieldnames
                self.duck_leader_LR = duck_leader_LR
                self.duck_leader_dist = duck_leader_dist

        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 59, struct.pack('<ff', self.duck_leader_LR, self.duck_leader_dist))
...
mavlink_map = {
        MAVLINK_MSG_ID_DUCK_LEADER_FOUND : MAVLink_duck_leader_found_message,
        MAVLINK_MSG_ID_DUCK_LEADER_LOC : MAVLink_duck_leader_loc_message,
...
class MAVLink(object):
        ...
        def decode(self, msgbuf):
                ...
                return m
        def duck_leader_found_encode(self, duck_leader_found):
                '''
                Tells the receiver whether leader information is available

                duck_leader_found         : bool value of whether leader is found (uint8_t)

                '''
                return MAVLink_duck_leader_found_message(duck_leader_found)

        def duck_leader_found_send(self, duck_leader_found):
                '''
                Tells the receiver whether leader information is available
                ...
                '''
                return self.send(self.duck_leader_found_encode(duck_leader_found))

        def duck_leader_loc_encode(self, duck_leader_LR, duck_leader_dist):
                '''
                Gives float value (-1..1) saying where leader is

                duck_leader_LR            : Location of duck leader from left to right (float)
                duck_leader_dist          : approximate distance of duck leader (float)

                '''
                return MAVLink_duck_leader_loc_message(duck_leader_LR, duck_leader_dist)

        def duck_leader_loc_send(self, duck_leader_LR, duck_leader_dist):
                '''
                Gives float value (-1..1) saying where leader is
                ...
                '''
                return self.send(self.duck_leader_loc_encode(duck_leader_LR, duck_leader_dist))
